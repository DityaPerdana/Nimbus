...
import { Activity, Code2, Star, Timer, TrendingUp, Trophy, UserIcon, CodeXml } from "lucide-react";
    ...
    >
      ...
      <div className="relative flex items-center gap-8">
        <div className="relative group">
          ...
          />
            <div
              className="absolute -top-2 -right-2 bg-gradient-to-r from-indigo-500 to-indigo-600 p-2
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-3xl font-bold text-white">{userData.name}</h1>
              <span className="px-3 py-1 bg-purple-500/10 text-indigo-400 rounded-full text-sm font-medium">
                Beta Tester
              </span>
          </div>
